...
/// <summary>
/// Configures ExecuteSimulationRun consumer endpoint: ConcurrentMessageLimit and PrefetchCount from WorkerSimulationOptions.
/// </summary>
public class ExecuteSimulationRunConsumerDefinition(
    IOptions<WorkerSimulationOptions> options) : ConsumerDefinition<ExecuteSimulationRunConsumer>
{
    [Obsolete("Overrides obsolete base member; required for MassTransit ConsumerDefinition")]
    protected override void ConfigureConsumer(IReceiveEndpointConfigurator endpointConfigurator,
        IConsumerConfigurator<ExecuteSimulationRunConsumer> consumerConfigurator)
    {
