...
public class UpdateActivityDefinitionRequestValidator : AbstractValidator<UpdateActivityDefinitionRequest>
{
    public UpdateActivityDefinitionRequestValidator()
    {
        RuleFor(x => x.Key)
            .NotEmpty()
